...
translate it game_script_aed2c5fb:
    ...
    "Estoy por llamarla, hacerle eco de lo que ha ocurrido, preguntarle si todo va bien..."

# game/game_script.rpy:692
translate it game_script_4c38b8ea:

    # "But the rational side of my brain interrupts."
    "Pero la parte sensata de mi cerebro me detiene."
...
translate it game_script_bfa380b0:
    ...
    "¿Y si está en clase? ¿Y si se le ha roto el teléfono?"

# game/game_script.rpy:694
translate it game_script_d9b6d526:

    # "She could be fine for all I know."
    "Por lo que sé, no tiene motivos para estar mal."
...
translate it game_script_56e847a8:
    ...
    "Está a salvo y es lo que importa."
...
translate it game_script_c6a22fa2:
    ...
    "A diferencia de su usual comportamiento alegre y risueño, hoy Monika está completamente impasible y muy tristona. "
...
translate it game_script_cf9b21ae:
    ...
    "No me parece correcto estar en un pasillo donde cualquiera pueda escuchar lo que estemos diciendo."

# game/game_script.rpy:749
translate it game_script_825a7a26:

    # "But now I have to explain in front of both Monika {i}and{/i} Yuri."
    "Así que tendré que explicarme frente a Monika y Yuri."
...
translate it game_script_bdfa6cfe:
    ...
    "Monika se sienta en la mesa del profesor con una expresión vacía que, de alguna manera, penetra en mi alma."
...
translate it game_script_d362a558:
    ...
    "Tal y como termino de hablar, Monika suaviza la expresión y frunce el ceño, preocupada."
...
translate it game_script_3e4fdc7b:
    ...
    mc "Sí... y no. Está a salvo, pero decir que está bien es exagerar..."
...
translate it game_script_6f9d1f4c:
    ...
    "Sus ojos se desvían, como si estuviese mirando al espacio."
...
translate it game_script_bed02e4f:
    ...
    m "He estado bastante estresada últimamente y el festival ha sido una de las principales razones."
...
translate it game_script_10ca3222:
    ...
    "Tras decir eso, nos inunda un silencio bastante incómodo."
...
translate it game_script_6542799f:
    ...
    "Por lo que sé, Sayori la considera una buena amiga, sin contar conmigo...{w} y quizás Monika."
...
translate it game_script_63888b72:
    ...
    "Pero, al mismo tiempo, no me siento cómodo diciéndoselo..."
...
translate it game_script_4294be29:
    ...
    "Y no es que me sienta cómodo mintiéndole a Natsuki acerca de esto..."
...
translate it game_script_c90baa36:
    ...
    mc "Algo... ocurrió y Sayori no pudo asistir. Como estaba con ella, yo tampoco pude asistir..."
...
translate it game_script_65a7ae30:
    ...
    "Aunque... tendrá sus razones si me está mintiendo a mí, de todas las personas del club."
...
translate it game_script_a6b22618:
    ...
    "Natsuki se detiene, mira alrededor y me mira de nuevo."
...
translate it game_script_add1976e:
    ...
    m "Pero bueno, aquí estabas. ¿Dónde te habías metido?"
...
translate it game_script_c0c91994:
    ...
    "Me ha pillado con la guardia baja porque estaba inmerso en mis pensamientos."
